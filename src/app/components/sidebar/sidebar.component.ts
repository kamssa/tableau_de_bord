...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/demande', title: 'Démande de terrain',  icon: 'dashboard', class: '' },
  ...
  { path: '/terrainAcheter', title: 'Terrains vendus',  icon: 'dashboard', class: '' },
  { path: '/terrainG', title: 'Terrains à Géo',  icon: 'dashboard', class: '' },
